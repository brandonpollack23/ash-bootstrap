...
use ash_bootstrap::{DebugMessenger, DeviceBuilder, InstanceBuilder, QueueFamilyCriteria, ValidationLayers};
...
fn main() {
  ...
  let device_features = vk::PhysicalDeviceFeatures2::builder().features(vk::PhysicalDeviceFeatures::builder().build());
